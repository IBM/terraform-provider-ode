...
func TestWithRequestID_RoundTrip(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			ctxSetup: func() context.Context {
				return transport.ContextWithRequestID(t.Context(), "req-abc-123")
			},
