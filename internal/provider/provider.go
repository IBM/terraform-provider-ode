	...
	resp.Schema = schema.Schema{
		Attributes: map[string]schema.Attribute{
			"ode_username": schema.StringAttribute{
				Optional:    true,
				Description: "Username for On-Demand Environments authentication. This can also be sourced from the `ODE_USERNAME` environment variable.",
			},
			"ode_password": schema.StringAttribute{
				Optional:    true,
				Sensitive:   true,
				Description: "Password for On-Demand Environments authentication. This can also be sourced from the `ODE_PASSWORD` environment variable.",
			},
			"ode_host": schema.StringAttribute{
				Optional:    true,
				Description: "Host for On-Demand Environments. This can also be sourced from the `ODE_HOST` environment variable.",
			},
...
func TLSAttribute() schema.Attribute {
	return schema.SingleNestedAttribute{
		Optional:            true,
		Description:         "Certificate for On-Demand Environments.",
		MarkdownDescription: "Certificate for On-Demand Environments.",
		Attributes: map[string]schema.Attribute{
			"ca_file": schema.StringAttribute{
				Optional:            true,
				Description:         "CA file for On-Demand Environments. This can also be sourced from the ODE_TLS_CA_FILE environment variable.",
				MarkdownDescription: "CA file for On-Demand Environments. This can also be sourced from the ODE_TLS_CA_FILE environment variable.",
			},
			"insecure_skip_verify": schema.BoolAttribute{
				Optional:            true,
				Description:         "Insecure SSL certificate for On-Demand Environments. This can also be sourced from the ODE_TLS_INSECURE_SKIP_VERIFY environment variable.",
				MarkdownDescription: "Insecure SSL certificate for On-Demand Environments. This can also be sourced from the ODE_TLS_INSECURE_SKIP_VERIFY environment variable.",
			},
			"server_name": schema.StringAttribute{
				Optional:            true,
				Description:         "Server name for On-Demand Environments.This can also be sourced from the ODE_TLS_SERVER_NAME environment variable.",
				MarkdownDescription: "Server name for On-Demand Environments. This can also be sourced from the ODE_TLS_SERVER_NAME environment variable.",
			},
		},
	}
}
